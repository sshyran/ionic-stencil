...
export const getClientPolyfill = async (config: d.Config, compilerCtx: CompilerCtx, polyfillFile: string) => {
...
export const getAppBrowserCorePolyfills = async (config: d.Config, compilerCtx: CompilerCtx) => {
